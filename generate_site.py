...
<p><small>Collected from official public status APIs with source URLs, timestamps, and normalized incident details. Sources: {esc(source_list)}. Built by statusfeed-dev.</small></p>
<p><small><a href="vendor-incident-history.html">Methodology: vendor incident history for reviews and postmortems</a></small></p></body></html>'''
